...
// NewUserOrderTwo is the golang structure of table new_user_order_two for DAO operations like Where/Data.
type NewUserOrderTwo struct {
	g.Meta        `orm:"table:new_user_order_two, do:true"`
	Id            interface{} // 主键id
	UserId        interface{} //
	TraderId      interface{} //
	...
	ExecutedQty   interface{} // 成交，biance返回真实的市价交易的数量
	AvgPrice      interface{} // 平均价格，biance返回真实的市价交易价格
	HandleStatus  interface{} //
	Status        interface{} //
	TimeInForce   interface{} //
